...
figure(2);
plot(1:n_epochs,h_weights(1:n_epochs,1),'r-','DisplayName','weight 1')
hold on
plot(1:n_epochs,h_weights(1:n_epochs,2),'b-','DisplayName','weight 2')
plot(1:n_epochs,h_threshold(1:n_epochs),'k-','DisplayName','threshold')
xlabel('\# of epochs', 'interpreter', 'latex', 'fontsize', 12)
